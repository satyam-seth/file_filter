...
As we know we frequently download any file in our computer it will automatically store them at the default download location and we also download different types of files, at the end-all the files get mixed up and then it becomes a headache to arrange these files.
